...
const uintptr_t __irq_vector_table _irq_vector_table[95] = {
...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[95] = {
	...
	{(const void *)0x800de24, (ISR)0x800288d}, /* 6 */
	{(const void *)0x800de20, (ISR)0x800288d}, /* 7 */
	{(const void *)0x800de1c, (ISR)0x800288d}, /* 8 */
	{(const void *)0x800de18, (ISR)0x800288d}, /* 9 */
	{(const void *)0x800de14, (ISR)0x800288d}, /* 10 */
	...
	{(const void *)0x800de10, (ISR)0x800288d}, /* 23 */
	...
	{(const void *)0x800cf80, (ISR)0x8007dd5}, /* 31 */
	{(const void *)0x800cf80, (ISR)0x8007ddd}, /* 32 */
	{(const void *)0x800cf64, (ISR)0x8007dd5}, /* 33 */
	{(const void *)0x800cf64, (ISR)0x8007ddd}, /* 34 */
	{(const void *)0x800cfb8, (ISR)0x8009f37}, /* 35 */
	...
	{(const void *)0x800de0c, (ISR)0x800288d}, /* 40 */
	...
	{(const void *)0x800cf9c, (ISR)0x8009f37}, /* 51 */
