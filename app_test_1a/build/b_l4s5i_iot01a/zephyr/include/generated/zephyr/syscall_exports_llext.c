...
EXPORT_GROUP_SYMBOL(SYSCALL, z_impl_led_blink);
EXPORT_GROUP_SYMBOL(SYSCALL, z_impl_led_get_info);
EXPORT_GROUP_SYMBOL(SYSCALL, z_impl_led_off);
EXPORT_GROUP_SYMBOL(SYSCALL, z_impl_led_on);
EXPORT_GROUP_SYMBOL(SYSCALL, z_impl_led_set_brightness);
EXPORT_GROUP_SYMBOL(SYSCALL, z_impl_led_set_channel);
EXPORT_GROUP_SYMBOL(SYSCALL, z_impl_led_set_color);
EXPORT_GROUP_SYMBOL(SYSCALL, z_impl_led_write_channels);
